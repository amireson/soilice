...
def ODEfun(t,DV,upperBC,TTop,TBot,TInf,jTopBC,jBotBC,E_PT,E_PS,z,dz,pars,const,opts,nz):
    return ODEfunCall(t,DV,upperBC,TTop,TBot,TInf,jTopBC,jBotBC,E_PT,E_PS,z,dz,pars,const,opts,nz)
...
class model:
    ...
    def setBCs(self,jTopBC=0,jBotBC=0,qI=0,psiT=0,TInf=0,TTop=0,TBot=0,E_PT=0,E_PS=0):
        ...
        self.E_PT   = _to_timeseries(E_PT)
        self.E_PS   = _to_timeseries(E_PS)
...
... please wait, model is running...
        ...
        for i in range(self.nt-1):
            ...
            params=(
                    ...
                    self.E_PT[i],self.E_PS[i],self.z,
